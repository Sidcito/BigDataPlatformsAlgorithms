...
# Creating a list of stopwords. Source: http://xpo6.com/list-of-english-stop-words/
...
for line in sys.stdin:
    ...
    # Print the key (word + docname) and 1 for all words one by one
    for word in words:
        if word in stopwords or word =='':
            pass
	else:
            print "{0} {1}\t{2}".format(word, docname, 1) # e.g. "word docname	1"
